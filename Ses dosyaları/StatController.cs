...
public class StatController : MonoBehaviour, IDamageable
{
    ...
    void Awake()
    {
        ...
        // Kısık olan ana AudioSource'a hiç dokunmuyoruz. 
        // Karaktere sadece efektleri çalması için YENİ bir AudioSource ekliyoruz.
        sfxSource = gameObject.AddComponent<AudioSource>();
        sfxSource.playOnAwake = false; // Başlar başlamaz rastgele ses çalmasın
        sfxSource.spatialBlend = 0f;   // 2D oyunlar için sesi her zaman %100 net duymamızı sağlar
    }
    ...
    {
        Debug.Log("Tecrübe kazanıldı: " + amount);
    }
