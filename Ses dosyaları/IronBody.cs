...
public class IronBody : MonoBehaviour
{
    ...
    public void use()
    {
        ...
        // 1. AÇILIŞ SESİ
        if (armorOpenSound != null) AudioSource.PlayClipAtPoint(armorOpenSound, Camera.main.transform.position);
    ...
    void RemoveArmorEffect()
    {
        ...
        if (armorCloseSound != null) AudioSource.PlayClipAtPoint(armorCloseSound, Camera.main.transform.position);
