   ...
   void HandleZoomOut()
{
    ...
    // GetKeyDown yerine GetKey kullanarak basılı tutma kontrolü yapıyoruz
    float targetSize = InputManager.GetKey("WeaponSpecial") ? (initialSize + zoomOutAmount) : initialSize;
