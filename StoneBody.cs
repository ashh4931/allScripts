   ...
   public void use()
    {
        ...
        // 1. SES ÇAL
        if (stoneBodySound != null) AudioManager.instance.PlaySFXAtPosition(stoneBodySound, Camera.main.transform.position);
...
statController.isStoneActive = true;
    ...
    // 1. KAPANIŞ SESİNİ ÇAL
        if (stopStoneBodySound != null) AudioManager.instance.PlaySFXAtPosition(stopStoneBodySound, Camera.main.transform.position);
